...
num_all_cont= hla_v5 %>% filter(pancreatitis == 0) %>% nrow()*2
...
num_all_case= hla_v5 %>% filter(pancreatitis == 1) %>% nrow()*2
...
num_all_cont_aj= hla_aj  %>% filter(pancreatitis == 0) %>% nrow()*2
...
num_all_case_aj= hla_aj %>% filter(pancreatitis == 1) %>% nrow()*2
...
num_all_cont_nonaj= hla_nonaj  %>% filter(pancreatitis == 0) %>% nrow()*2
...
num_all_case_nonaj= hla_nonaj %>% filter(pancreatitis == 1) %>% nrow()*2
